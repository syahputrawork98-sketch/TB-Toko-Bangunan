...
| **F03** | Inventory Management | Client / Server | Admin | Pengelolaan data inventaris barang (CRUD), penyesuaian stok, serta pembedaan harga beli (HPP) vs harga jual. | **Implemented** | [Detail](features/F03_INVENTORY_MANAGEMENT.md) |
| **F04** | Staff Management | Client / Server | Admin | Pendaftaran akun kasir/CS baru serta pengaturan status keaktifan akun staff. | **Implemented** | [Detail](features/F04_STAFF_MANAGEMENT.md) |
| **F05** | Shop Settings | Client / Server | Admin | Pengaturan profil fisik toko (nama, alamat, telepon struk) dan batas minimum stok tipis global. | **Implemented** | [Detail](features/F05_SHOP_SETTINGS.md) |
